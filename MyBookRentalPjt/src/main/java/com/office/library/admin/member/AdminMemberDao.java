...
public class AdminMemberDao {
	...
	public int updateAdminAccount(AdminMemberVo adminMemberVo) {
		...
		String sqlString ="UPDATE tbl_my_admin_member SET a_m_name = ? , a_m_pw = ? , a_m_gender = ? , a_m_part = ? , a_m_position = ? , a_m_mail = ? , a_m_phone = ? , a_m_mod_date = NOW() WHERE a_m_no = ?";
		int result =-1;
		try {
			result = jdbcTemplate.update(sqlString , adminMemberVo.getA_m_name() ,passwordEncoder.encode(adminMemberVo.getA_m_pw()), adminMemberVo.getA_m_gender(), adminMemberVo.getA_m_part() , adminMemberVo.getA_m_position() , adminMemberVo.a_m_mail , adminMemberVo.getA_m_phone() , adminMemberVo.a_m_no);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return result;
	...
	public AdminMemberVo selectAdmin(int a_m_no) {
		...
		String sql = "SELECT * FROM tbl_my_admin_member WHERE a_m_no = ? ";
	...
	public AdminMemberVo selectAdmin(String a_m_id , String a_m_name , String a_m_mail) {
		...
		String sql = "SELECT * FROM tbl_my_admin_member WHERE a_m_id = ? AND a_m_name = ? AND a_m_mail = ?";
	...
	public int updatePassword(String a_m_id , String newPassword) {
		String sql = "UPDATE tbl_my_admin_member SET a_m_pw = ? , a_m_mod_date = NOW() WHERE a_m_id = ?";
